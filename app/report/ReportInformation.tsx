...
export default function ReportInformation() {
    return (
        <div className='w-full bg-white p-8 my-10 rounded-3xl shadow-[0px_2px_4px_0px_rgba(0,0,0,0.1)]'>
            ...
            <div className='w-full flex gap-10 items-start justify-between flex-col lg:flex-row'>
                <div className='w-full'>
                    ...
                    <p className='text-sm font-comfortaa mt-2 leading-[1.25] text-slate-500'>
                        ...
                        Incidunt fugit dignissimos, provident dolore iste
                        tenetur quod id in consequuntur reiciendis ipsum cumque
                        aspernatur.
                    </p>
                    <div className='mt-4'>
                        {[
