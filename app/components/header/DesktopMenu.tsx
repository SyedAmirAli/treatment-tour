...
function ChildrenMenu({ menu }: ChildrenMenuProps) {
    return (
        <ul className='2xl:absolute top-[72px] left-0 bg-white shadow-[0px_2px_4px_0px_rgba(0,0,0,0.1)] group-[.active]:py-4'>
            {menu.map((cItem, i) => (
...
function ChildrenMenuItem({ menuItem }: { menuItem: ChildrenMenuItemType }) {
    ...
    return (
        <li className='px-4 py-1 2xl:w-56 hidden 2xl:group-hover:block group-[.active]:block group children relative'>
            <a
                href='#'
